  ...
  _createClass(Schemer, [{
    ...
    value: function () {
      var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(_ref6) {
        ...
        var _dimensions, _square, _contentTypePattern, filePath, probeResult, width, height, type, mime;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _dimensions = meta.dimensions, _square = meta.square, _contentTypePattern = meta.contentTypePattern;
    ...
    value: function () {
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.next = 4;
                return this._validateImageAsync({ fieldPath: fieldPath, data: data, meta: meta });
      ...
      function _validateAssetAsync(_x7) {
    ...
    value: function () {
      var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(fieldPath, data) {
        var subSchema;
      ...
      function validateProperty(_x8, _x9) {
