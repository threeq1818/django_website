...
async function getManifest(publicUrl, opts = {}) {
  const req = {
    url: publicUrl,
    method: 'get',
    headers: {
  ...
  if (opts.platform && exp.platform !== opts.platform && opts.platform !== 'all') {
    throw new (_XDLError().default)('INVALID_MANIFEST', `Manifest from ${publicUrl} is not compatible with the ${opts.platform} platform`);
  }
