...
declare function regexFileAsync(regex: RegExp, replace: string, filename: string): Promise<void>;
declare function deleteLinesInFileAsync(startRegex: RegExp, endRegex: RegExp, filename: string): Promise<void>;
